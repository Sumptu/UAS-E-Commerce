<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Edit Paket</h6>
    </div>
    <div class="card-body">
        <form action="<?php echo BASE_URL; ?>/admin/editPaket/<?php echo $data['id']; ?>" method="POST" class="needs-validation" novalidate>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control currency-input <?php echo (!empty($data['harga_err'])) ? 'is-invalid' : ''; ?>" id="harga" name="harga" value="<?php echo number_format($data['harga'], 0, ',', '.'); ?>" required>
                <div class="invalid-feedback">
